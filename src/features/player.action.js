...
export function getNewAction(direction) {
  switch (direction) {
    case "WALK_WEST":
      return { side: "WEST", steps: 7, animation: "WALK_WEST" };
    case "WALK_EAST":
      return { side: "EAST", steps: 7, animation: "WALK_EAST" };
    case "WALK_NORTH":
      return { side: "NORTH", steps: 7, animation: "WALK_NORTH" };
    case "WALK_SOUTH":
